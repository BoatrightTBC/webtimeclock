...
if (mysqli_connect_error())
  {
  echo "Server:".$lcServer." Failed to connect to MySQL: " . mysqli_connect_error();
  return;
}
...
if ($onetime == "yes") {	//This call is coming from sysdata -- the initial call
    ...
    if ($token == '') {
// Our own version of double checking token		
    ...
    setcookie('token',$token,time() + (86400 * 7)); // One day
