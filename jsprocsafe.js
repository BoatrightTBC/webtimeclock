...
function loadSysdata() {
	...
	$.ajax({
	    ...
	    {
//	        doalert("Connection Error with AJAX aa call", "Error");			 
	        badLogin();			 
	    }
	});			
    doclear();	
...
function clocknoAjax(pcValue) {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAbb X call", "Error");			 
	    }
	});	
...
function custsAjax() {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAX cccall", "Error");			 
	    }
	});	
}
...
function contsAjax(pcValue) {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAX ddcall", "Error");			 
	    }
	});	
}
...
function TasksAjax(pcValue) {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAX eecall", "Error");			 
	    }
	});	
}
...
function emplLettersAjax() {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAXff call", "Error");			 
	    }
	});	
}
...
function emplsAjax(pcValue) {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAXgg call", "Error");			 
	    }
	});	
}
...
function clockInAjax(pcValue) {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAX hhcall", "Error");			 
	    }
	});	
}
...
function magicAjax(pcValue) {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAXii call", "Error");			 
	    }
	});	
}
...
function timesAjax(pcValue) {
	...
	return $.ajax({
	    ...
	    error: function (jqXHR, textStatus, errorThrown)
	    {
	        doalert("Connection Error with AJAX call", "Error");			 
	    }
	});	
}
